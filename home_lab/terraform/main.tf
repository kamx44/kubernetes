locals {
  ...
  github_runners = {
    "runner1" = {
      vm_name     = "k8s-vm-runner1"
      vmid        = 200
      ip_cidr     = "192.168.137.30/24"
      mac_address = "bc:24:11:2b:41:15"
      cores       = 2
      memory      = 2048
    }
  }
